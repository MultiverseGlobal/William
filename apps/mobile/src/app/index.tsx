...
// API Url mapping: defaults to production Vercel serverless deployment
const API_URL = process.env.EXPO_PUBLIC_API_URL || 'https://william-web-zeta.vercel.app/api';
