...
CREATE TABLE IF NOT EXISTS chats (
  id TEXT PRIMARY KEY,
  sender TEXT NOT NULL CHECK (sender IN ('user', 'orion')),
  text TEXT,
  time TEXT,
...
(
  'j_career_1', 'career', 'Target', 'Orion Companion Platform',
...
(
  'l_1', 'lesson', 'Systems Over Motivation', 'Orion',
...
(
  'l_2', 'idea', 'Companion Platform Vision', 'Orion',
  ...
  '2026-07-21',
  '["AI Architecture", "Orion", "Philosophy"]'
) ON CONFLICT (id) DO NOTHING;
...
('b1', 'Executive Daily Digest', '09:00 AM • Chief of Staff Auto-Summary', '2 pull requests merged into Orion web-v2. No blocking incidents. Team schedule is 20 mins ahead.', false, 'digest', '10 mins ago'),
