...
export function FocusMode({
  ...
  const lastOrionMsg = messages.filter(m => m.sender === 'orion').at(-1)?.text ?? '';
    ...
    >
      ...
      <div className="focus-body">
        ...
        <div className="focus-context">
          <div>
            <p style={{ fontSize: 10, fontWeight: 600, letterSpacing: '0.07em', textTransform: 'uppercase', color: 'rgba(161,161,170,0.85)', marginBottom: 6 }}>
              You
            </p>
      ...
      <div className="focus-footer">
        <div style={{
          ...
          <input
            ...
            onKeyDown={handleKeyDown}
            placeholder="Tell Orion something…"
            disabled={isSending}
            style={{
              flex: 1,
